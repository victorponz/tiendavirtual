...
class UserController
{
    ...
    public function login($request, $response, $args) {
         ...
         return $this->container->renderer->render($response, "login.view.php", compact('title', 'info', 'form', 'hrefReturnToUrl', 'withCategories'));
    ...
    public function register($request, $response, $args) {
      ...
      return $this->container->renderer->render($response, "register.view.php", compact('title', 'info', 'form', 'hrefReturnToUrl', 'withCategories'));
    }
